...
class HttpElementFactory {
    static getHttpElements(line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            originalElements.push(new httpElement_1.HttpElement(`{{${Constants.GuidVariableName}}}`, httpElement_1.ElementType.GlobalVariable, null, Constants.GuidVariableDescription));
            originalElements.push(new httpElement_1.HttpElement(`{{${Constants.TimeStampVariableName}}}`, httpElement_1.ElementType.GlobalVariable, null, Constants.TimeStampVariableDescription));
            originalElements.push(new httpElement_1.HttpElement(`{{${Constants.RandomInt}}}`, httpElement_1.ElementType.GlobalVariable, null, Constants.RandomIntDescription));
            ...
            for (var variableName in customVariables) {
                originalElements.push(new httpElement_1.HttpElement(`{{${variableName}}}`, httpElement_1.ElementType.CustomVariable, null, `Value: ${customVariables[variableName]}`));
            }
            ...
            if (elements.length === 0) {
                ...
                originalElements.filter(e => !e.prefix && (e.type === httpElement_1.ElementType.GlobalVariable || e.type === httpElement_1.ElementType.CustomVariable)).forEach(element => {
                    elements.push(element);
                });
            }
            return elements;
